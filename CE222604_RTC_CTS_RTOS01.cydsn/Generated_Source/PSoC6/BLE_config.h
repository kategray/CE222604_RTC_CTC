...
#define CY_BLE_ADV_PKT_0_INDEX_SERVICE_SOLICITATION_16   (0x0Cu)
#define CY_BLE_ADV_PKT_0_INDEX_APPEARANCE   (0x10u)
#define CY_BLE_SCN_PKT_0_INDEX_LOCAL_NAME   (0x00u)
#define CY_BLE_SCN_PKT_0_INDEX_TX_POWER_LEVEL   (0x09u)
...
#define CY_BLE_GATT_DB_INDEX_COUNT                  (0x000Bu)
...
#define CY_BLE_CONFIG_GATT_DB_ATT_VAL_COUNT         (0x05u)
