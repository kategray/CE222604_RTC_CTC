...
#define CY_BLE_STACK_PATCH                                               (2u)

/** Firmware build number. */
#define CY_BLE_STACK_BUILD                                               (917u)
...
* CY_BLE_CONFIG_ENABLE_LL_PRIVACY macro is set by the user in the BLE_config.h file.  
*
* \return
*    None.
*
...
* CY_BLE_CONFIG_LL_MAX_TX_PAYLOAD_SIZE or CY_BLE_CONFIG_LL_MAX_RX_PAYLOAD_SIZE macro (in BLE_config.h)
...
* This function is called by the BLE Component during BLE initialization if the
* CY_BLE_CONFIG_ENABLE_PHY_UPDATE macro is set in the BLE_config.h file.
*
* \return
*    None.
*
