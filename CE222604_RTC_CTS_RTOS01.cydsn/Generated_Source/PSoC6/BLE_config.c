...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x05u, 0x08u, 0x09u, 0x52u, 0x54u,
        0x43u, 0x20u, 0x43u, 0x54u, 0x53u, 0x03u, 0x14u,
        0x05u, 0x18u, 0x03u, 0x19u, 0xC0u, 0x00u, 0x00u,
...
cy_stc_ble_gapp_scan_rsp_data_t cy_ble_scanRspData[0x01u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x08u, 0x09u, 0x52u, 0x54u, 0x43u, 0x20u, 0x43u,
        0x54u, 0x53u, 0x02u, 0x0Au, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u,
        0x00u, 0x00u, 0x00u }, /* uint8_t scan_rsp_data[CY_BLE_MAX_SCAN_RSP_DATA_LEN] */ 
        0x0Cu, /* uint8_t scan_rsp_data_length */ 
    },
};
...
static uint8_t cy_ble_attValues[0x15u] = {
    /* Device Name */
    (uint8_t)'R', (uint8_t)'T', (uint8_t)'C', (uint8_t)' ', (uint8_t)'C', (uint8_t)'T', (uint8_t)'S', 

    /* Appearance */
    0xC0u, 0x00u, 

    /* Peripheral Preferred Connection Parameters */
    0xE8u, 0x03u, 0xD0u, 0x07u, 0x00u, 0x00u, 0xB8u, 0x0Bu, 
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x05u] = {
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x0Bu] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x01020003u /* rd    */, 0x0003u, {{0x0007u, (void *)&cy_ble_attValuesLen[0]}} },
    ...
    { 0x0007u, 0x2A04u /* Peripheral Preferred Connection Par */, 0x01020003u /* rd    */, 0x0007u, {{0x0008u, (void *)&cy_ble_attValuesLen[2]}} },
